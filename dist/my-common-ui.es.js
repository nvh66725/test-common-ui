...
function cr() {
  if (Oe) return F;
  Oe = 1;
  var P = Ce, h = Symbol.for("react.element"), N = Symbol.for("react.fragment"), T = Object.prototype.hasOwnProperty, I = P.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, W = { key: !0, ref: !0, __self: !0, __source: !0 };
  function j(R, c, O) {
    var p, b = {}, E = null, $ = null;
    ...
    return { $$typeof: h, type: R, key: E, ref: $, props: b, _owner: I.current };
  }
...
function vr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var P = Ce, h = Symbol.for("react.element"), N = Symbol.for("react.portal"), T = Symbol.for("react.fragment"), I = Symbol.for("react.strict_mode"), W = Symbol.for("react.profiler"), j = Symbol.for("react.provider"), R = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), O = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), E = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), Q = Symbol.iterator, Pe = "@@iterator";
    function je(e) {
    ...
    function We(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === T || e === W || Ie || e === I || e === O || e === p || Ae || e === $ || ke || De || Fe || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === b || e.$$typeof === j || e.$$typeof === R || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    function Ee(e, r) {
      {
        ...
        Re[t] = !0;
        var n = "";
        e && e._owner && e._owner !== z.current && (n = " It was passed a child from " + y(e._owner.type) + "."), w(e), l('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), w(null);
      }
    }
    function _e(e, r) {
      {
    ...
    function Te(e, r, t, n, o, u) {
      {
        ...
        if (!i) {
          ...
          v ? a += v : a += he();
          var s;
          e === null ? s = "null" : K(e) ? s = "array" : e !== void 0 && e.$$typeof === h ? (s = "<" + (y(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, l("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var f = er(e, r, t, o, u);
        if (f == null)
          return f;
        ...
        if (k.call(r, "key")) {
          var m = y(e), d = Object.keys(r).filter(function(lr) {
            return lr !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Z, m, fr, m), me[m + Z] = !0;
          }
        }
...
var pr = dr();
function yr({ label: P, onClick: h }) {
  return /* @__PURE__ */ pr.jsx("button", { onClick: h, children: P });
}
export {
  yr as Button
};
